...
LABEL name="gobenchdata to gh-pages"
LABEL version="0.0.1"
...
LABEL "com.github.actions.name"="Run and Publish Go Benchmark Data to gh-pages"
LABEL "com.github.actions.description"="Runs your benchmarks and updates a JSON file in your gh-pages branch"
